...
@CDIView(PieView.VIEW_ID)
public class PieView  extends VerticalLayout implements View {
	/**
	 * 
	 */
	...
	public static final String VIEW_ID = "pieChart";
	...
	public void init(){
		...
		try {
			addComponent(chartBuilder.getChart(ChartType.PIE));
		} catch (Exception e) {
